export const blahajDb = {
	...
	smolhåj: {
		...
		europe: [
			...
			["de", "de", "20540663"], // germany
			["gb", "en", "20540663"], // united kingdom
			["fr", "fr", "20540663"], // france
			["it", "it", "20540663"], // italy
			["es", "es", "20540663"], // spain
			["ua", "uk", "20540663"], // ukraine
			["pl", "pl", "20540663"], // poland
			["ro", "ro", "20540663"], // romania
			["nl", "nl", "20540663"], // netherlands
			["be", "nl", "20540663"], // belgium
			["cz", "cs", "20540663"], // czech republic
			// greece has a different api
			["pt", "pt", "20540663"], // portugal
			["se", "sv", "20540663"], // sweden
			["hu", "hu", "20540663"], // hungary
			// belarus has no ikea
			["at", "de", "20540663"], // austria
			["rs", "sr", "20540663"], // serbia
			["ch", "en", "20540663"], // switzerland
			// bulgaria has a different api
			["dk", "da", "20540663"], // denmark
			["fi", "fi", "20540663"], // finland
			["sk", "sk", "20540663"], // slovakia
			["no", "no", "20540663"], // norway
			["ie", "en", "20540663"], // ireland
			["hr", "hr", "20540663"], // croatia
			// moldova has like fake ikea what
			// lithuania has a different api
			// north macedonia has no ikea
			["si", "sl", "20540663"], // slovenia
			// latvia has a different api
			// montenegro has another fake ikea
			// luxembourg has no ikea yet, until 2025
			// iceland has a different api
